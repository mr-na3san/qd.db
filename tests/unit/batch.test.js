...
describe('BatchManager - Basic Operations', () => {
  test('should execute batch after reaching maxBatchSize', async () => {
    ...
    await batch.add({ key: 'key1', value: 'value1' });
    await batch.add({ key: 'key2', value: 'value2' });
    
    expect(executedOperations.length).toBe(0);
    
    await batch.add({ key: 'key3', value: 'value3' });
